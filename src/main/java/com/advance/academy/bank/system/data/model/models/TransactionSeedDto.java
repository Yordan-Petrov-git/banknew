...
public class TransactionSeedDto {
    ...
    public TransactionSeedDto() {
    }

    public TransactionSeedDto(BankViewDto bank, AccountViewDto recipient, AccountViewDto sender, String description, Instant dateCreated, Instant dateCompleted, Instant dateUpdated, TransactionStatus transactionStatus, Long fee, BigDecimal amount) {
        this.bank = bank;
